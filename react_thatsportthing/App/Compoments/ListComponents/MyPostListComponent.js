...
class MyPostListComponent extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      page: 1,
  ...
  makeRemoteRequest = token => {
    ...
    const url =ApiUrl.getMyPostsList;
    ...
    console.log('MyPostListCompoment',this.state.page);
    fetch(url, postData)
      .then(res => res.json())
      .then(responseJson => {
        // console.log('MyPostListCompoment',responseJson);
